			...
			<div class="row">
				<div class="col-md-6 col-xl-4">
					<div class="feature-box mrb-lg-60">
						...
						<div class="feature-content">
							...
							<div class="para">
								<p>Daha renkli ve daha aktif, internet ortamında gülümseyen bir markanız olsun.</p>
							</div>
							<div class="link">
				...
				<div class="col-md-6 col-xl-4">
					<div class="feature-box mrb-lg-60">
						...
						<div class="feature-content">
							...
							<div class="para">
								<p>Sosyal medyada profesyonel bir reklam stratejisi izlemeniz markanızı duyurmanızda en etkili yoldur.</p>
							</div>
							<div class="link">
								<a href="#"><i class="fas fa-long-arrow-alt-right"></i></a>
							</div>
				...
				<div class="col-md-6 col-xl-4">
					<div class="feature-box">
						...
						<div class="feature-content">
							<div class="title">
								<h3>Grafik & Video Tasarım</h3>
							</div>
							<div class="para">
								<p>Etkili ve çekici grafik ve video tasarımları markanızın dış görünüşüdür. İlk görüşte iyi bir izlenim bırakın.</p>
							</div>
							<div class="link">
								<a href="#"><i class="fas fa-long-arrow-alt-right"></i></a>
							</div>
